...
type SearchParams = Promise<{ booked?: string; tab?: string; property?: string }>;

export default async function ReceptionistShowingsPage({ searchParams }: { searchParams: SearchParams }) {
  const { booked, tab, property } = await searchParams;
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <ShowingsTabs activeTab={activeTab} basePath="/receptionist/showings" propertyId={propertyId || undefined} />
